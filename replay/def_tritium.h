...
const char* ROOTFILE_DIR_PREFIX = "/volatile/halla/triton/Marathon_Rootfiles/%s";
...
TString STD_REPLAY_OUTPUT_DIR= TString::Format(ROOTFILE_DIR_PREFIX,gSystem->Getenv("OUT_DIR"));
